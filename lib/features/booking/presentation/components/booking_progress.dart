...
class BookingProgress extends StatelessWidget {
  ...
  static const List<String> _hints = <String>[
    'Два клуба, разная вместимость. Оплата на месте — сейчас только держим за вами места.',
    'Сначала выберите время: под каждым слотом видно, сколько мест в этом зале свободно.',
    'Отметьте места для своей компании — одно место на человека.',
